...
public final class WorldHeightScreenHooks {
    ...
    private static void onInit(CreateWorldScreen screen) {
        ...
        minBox.setTooltip(Tooltip.create(Component.literal("Must be divisible by 16; allowed roughly -2016 to 2015.")));
        ...
        maxBox.setTooltip(Tooltip.create(Component.literal("Must be divisible by 16; height stays a multiple of 16 (max practical top is 2015).")));
    ...
    private static void refreshBoxes(CreateWorldScreen screen) {
        // The world-creation UI in 1.20.4 rebuilds its tab layout differently, which meant our widgets
        // occasionally disappeared. Keep them visible on the whole create-world screen to avoid losing
        // the controls.
