...
public final class WorldHeightScreenHooks {
    ...
    private static void onInit(CreateWorldScreen screen) {
        ...
        minBox.setTooltip(Tooltip.create(Component.literal("Must be divisible by 16; allowed roughly -2016 to -64.")));
        ...
        maxBox.setTooltip(Tooltip.create(Component.literal("Must be divisible by 16; bottom at least -2016, top at least 320 and up to 2015.")));
