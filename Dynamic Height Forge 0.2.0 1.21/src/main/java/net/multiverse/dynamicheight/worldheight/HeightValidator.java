...
public final class HeightValidator {
    ...
    // Vanilla 1.21 limits: min -64, max 320. Avoid obfuscated static fields at runtime.
    private static final int WORLD_MIN_Y = -64;
    private static final int WORLD_MAX_Y = 320;
    public static final int MAX_MIN_Y = WORLD_MIN_Y;
    ...
    public static int sanitizeMin(int value) {
        int maxMin = Math.min(WORLD_MAX_Y - SECTION_SIZE, MAX_MIN_Y);
        int clamped = Math.max(WORLD_MIN_Y, Math.min(value, maxMin));
