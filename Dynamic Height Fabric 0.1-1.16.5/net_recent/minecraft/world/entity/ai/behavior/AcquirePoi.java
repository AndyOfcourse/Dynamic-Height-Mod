...
public class AcquirePoi extends Behavior<PathfinderMob> {
   ...
   protected void start(ServerLevel serverLevel, PathfinderMob pathfinderMob, long l) {
      ...
      Predicate<BlockPos> predicate = blockPos -> {
         AcquirePoi.JitteredLinearRetry jitteredLinearRetry = (AcquirePoi.JitteredLinearRetry)this.batchCache.get(blockPos.asLong());
      ...
      Set<BlockPos> set = poiManager.findAllClosestFirst(
