...
public class BlockModelGenerators {
   ...
   private void createHorizontallyRotatedBlock(Block block, TexturedModel.Provider provider) {
      ...
      this.blockStateOutput
         .accept(
            MultiVariantGenerator.multiVariant(block, Variant.variant().with(VariantProperties.MODEL, resourceLocation)).with(createHorizontalFacingDispatch())
         );
   }
   ...
   private void createCoralFans(Block block, Block block2) {
      ...
      this.blockStateOutput
         .accept(
            MultiVariantGenerator.multiVariant(block2, Variant.variant().with(VariantProperties.MODEL, resourceLocation2))
                  ...
                  PropertyDispatch.property(BlockStateProperties.AGE_7)
                     .generate(
                        integer -> Variant.variant()
                              .with(VariantProperties.MODEL, ModelTemplates.STEMS[integer].create(block, textureMapping, this.modelOutput))
                     )
               )
         );
   }
      ...
      if (property.getPossibleValues().size() != is.length) {
         ...
         PropertyDispatch propertyDispatch = PropertyDispatch.property(property)
            .generate(
               integer -> {
                  int i = is[integer];
                  ResourceLocation resourceLocation = (ResourceLocation)int2ObjectMap.computeIfAbsent(
            ...
            MultiVariantGenerator.multiVariant(block)
               .with(
                  PropertyDispatch.property(BlockStateProperties.FACING)
                     .select(
                        Direction.DOWN,
                        Variant.variant().with(VariantProperties.MODEL, resourceLocation2).with(VariantProperties.X_ROT, VariantProperties.Rotation.R180)
                     )
   ...
   private void createGrassLikeBlock(Block block, ResourceLocation resourceLocation, Variant variant) {
      ...
      this.blockStateOutput
         .accept(
            MultiVariantGenerator.multiVariant(block).with(PropertyDispatch.property(BlockStateProperties.SNOWY).select(true, variant).select(false, list))
         );
   }
               ...
               .with(
                  PropertyDispatch.properties(BlockStateProperties.SHORT, BlockStateProperties.PISTON_TYPE)
                     .select(
                        ...
                        Variant.variant()
                           .with(
                              VariantProperties.MODEL, ModelTemplates.PISTON_HEAD.createWithSuffix(Blocks.PISTON, "_head", textureMapping3, this.modelOutput)
                           )
                     )
                     .select(
                        false,
                     ...
                     .select(
                        ...
                        Variant.variant()
                           .with(
                              VariantProperties.MODEL,
                              ModelTemplates.PISTON_HEAD_SHORT.createWithSuffix(Blocks.PISTON, "_head_short_sticky", textureMapping2, this.modelOutput)
                           )
                     )
               )
               .with(createFacingDispatch())
                  ...
                  PropertyDispatch.property(BlockStateProperties.LAYERS)
                     .generate(
                        integer -> Variant.variant()
                              .with(
                                 VariantProperties.MODEL,
                                 integer < 8 ? ModelLocationUtils.getModelLocation(Blocks.SNOW, "_height" + integer * 2) : resourceLocation
                              )
                     )
               )
         );
                  ...
                  PropertyDispatch.property(BlockStateProperties.AGE_3)
                     .generate(
                        integer -> Variant.variant()
                              .with(
                                 VariantProperties.MODEL,
                                 this.createSuffixedVariant(Blocks.SWEET_BERRY_BUSH, "_stage" + integer, ModelTemplates.CROSS, TextureMapping::cross)
                              )
                     )
               )
         );
      ...
      switch(integer2) {
         ...
         case 1:
            return this.createTurtleEggModel(
               integer, "slightly_cracked_", TextureMapping.cube(TextureMapping.getBlockTexture(Blocks.TURTLE_EGG, "_slightly_cracked"))
            );
         case 2:
            ...
            MultiVariantGenerator.multiVariant(Blocks.VINE)
               .with(
                  PropertyDispatch.properties(
                     ...
                     .select(
                        true, true, true, false, false, Variant.variant().with(VariantProperties.MODEL, ModelLocationUtils.getModelLocation(Blocks.VINE, "_3"))
                     )
                     .select(
                        true,
                        false,
                     ...
                     .select(
                        true, true, true, false, true, Variant.variant().with(VariantProperties.MODEL, ModelLocationUtils.getModelLocation(Blocks.VINE, "_4"))
                     )
                     .select(
                        false,
                        false,
                     ...
                     .select(
                        true, true, true, true, false, Variant.variant().with(VariantProperties.MODEL, ModelLocationUtils.getModelLocation(Blocks.VINE, "_3u"))
                     )
                     .select(
                        true,
                        false,
                     ...
                     .select(
                        true, true, true, true, true, Variant.variant().with(VariantProperties.MODEL, ModelLocationUtils.getModelLocation(Blocks.VINE, "_4u"))
                     )
               )
         );
   }
   ...
   public void run() {
      ...
      this.createTrivialBlock(
         ...
         TexturedModel.COLUMN
            .updateTexture(textureMapping -> textureMapping.put(TextureSlot.SIDE, TextureMapping.getBlockTexture(Blocks.CHISELED_QUARTZ_BLOCK)))
      );
