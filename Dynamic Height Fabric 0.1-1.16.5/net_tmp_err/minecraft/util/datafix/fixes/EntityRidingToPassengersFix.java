         ...
         return TypeRewriteRule.seq(
            this.fixTypeEverywhere(
               ...
               dynamicOps -> pair -> {
                     ...
                     while(true) {
                        Either<List<NewEntityTree>, Unit> either = (Either)DataFixUtils.orElse(
                           optional.map(
                              pairx -> {
                                 Typed<NewEntityTree> typed = (Typed)type2.pointTyped(dynamicOps)
                        ...
                        pair2 = (Pair)new Typed(type, dynamicOps, optional2.get())
