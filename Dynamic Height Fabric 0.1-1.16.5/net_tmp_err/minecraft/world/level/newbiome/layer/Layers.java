...
public class Layers {
   ...
   private static <T extends Area, C extends BigContext<T>> AreaFactory<T> getDefaultLayer(boolean bl, int i, int j, LongFunction<C> longFunction) {
      AreaFactory<T> areaFactory = IslandLayer.INSTANCE.run(longFunction.apply(1L));
      areaFactory = ZoomLayer.FUZZY.run(longFunction.apply(2000L), areaFactory);
      areaFactory = AddIslandLayer.INSTANCE.run(longFunction.apply(1L), areaFactory);
      areaFactory = ZoomLayer.NORMAL.run(longFunction.apply(2001L), areaFactory);
      areaFactory = AddIslandLayer.INSTANCE.run(longFunction.apply(2L), areaFactory);
      areaFactory = AddIslandLayer.INSTANCE.run(longFunction.apply(50L), areaFactory);
      areaFactory = AddIslandLayer.INSTANCE.run(longFunction.apply(70L), areaFactory);
      areaFactory = RemoveTooMuchOceanLayer.INSTANCE.run(longFunction.apply(2L), areaFactory);
      AreaFactory<T> areaFactory2 = OceanLayer.INSTANCE.run(longFunction.apply(2L));
      areaFactory2 = zoom(2001L, ZoomLayer.NORMAL, areaFactory2, 6, longFunction);
      areaFactory = AddSnowLayer.INSTANCE.run(longFunction.apply(2L), areaFactory);
      areaFactory = AddIslandLayer.INSTANCE.run(longFunction.apply(3L), areaFactory);
      areaFactory = AddEdgeLayer.CoolWarm.INSTANCE.run(longFunction.apply(2L), areaFactory);
      areaFactory = AddEdgeLayer.HeatIce.INSTANCE.run(longFunction.apply(2L), areaFactory);
      areaFactory = AddEdgeLayer.IntroduceSpecial.INSTANCE.run(longFunction.apply(3L), areaFactory);
      areaFactory = ZoomLayer.NORMAL.run(longFunction.apply(2002L), areaFactory);
      areaFactory = ZoomLayer.NORMAL.run(longFunction.apply(2003L), areaFactory);
      areaFactory = AddIslandLayer.INSTANCE.run(longFunction.apply(4L), areaFactory);
      areaFactory = AddMushroomIslandLayer.INSTANCE.run(longFunction.apply(5L), areaFactory);
      areaFactory = AddDeepOceanLayer.INSTANCE.run(longFunction.apply(4L), areaFactory);
      ...
      areaFactory3 = RiverInitLayer.INSTANCE.run(longFunction.apply(100L), areaFactory3);
      AreaFactory<T> areaFactory4 = new BiomeInitLayer(bl).run(longFunction.apply(200L), areaFactory);
      areaFactory4 = RareBiomeLargeLayer.INSTANCE.run(longFunction.apply(1001L), areaFactory4);
      areaFactory4 = zoom(1000L, ZoomLayer.NORMAL, areaFactory4, 2, longFunction);
      areaFactory4 = BiomeEdgeLayer.INSTANCE.run(longFunction.apply(1000L), areaFactory4);
      AreaFactory<T> areaFactory5 = zoom(1000L, ZoomLayer.NORMAL, areaFactory3, 2, longFunction);
      areaFactory4 = RegionHillsLayer.INSTANCE.run(longFunction.apply(1000L), areaFactory4, areaFactory5);
      ...
      areaFactory3 = RiverLayer.INSTANCE.run(longFunction.apply(1L), areaFactory3);
      areaFactory3 = SmoothLayer.INSTANCE.run(longFunction.apply(1000L), areaFactory3);
      areaFactory4 = RareBiomeSpotLayer.INSTANCE.run(longFunction.apply(1001L), areaFactory4);

      for(int k = 0; k < i; ++k) {
         areaFactory4 = ZoomLayer.NORMAL.run(longFunction.apply((long)(1000 + k)), areaFactory4);
         if (k == 0) {
            areaFactory4 = AddIslandLayer.INSTANCE.run(longFunction.apply(3L), areaFactory4);
         }

         if (k == 1 || i == 1) {
            areaFactory4 = ShoreLayer.INSTANCE.run(longFunction.apply(1000L), areaFactory4);
         }
      }

      areaFactory4 = SmoothLayer.INSTANCE.run(longFunction.apply(1000L), areaFactory4);
      areaFactory4 = RiverMixerLayer.INSTANCE.run(longFunction.apply(100L), areaFactory4, areaFactory3);
      return OceanMixerLayer.INSTANCE.run(longFunction.apply(100L), areaFactory4, areaFactory2);
   }
