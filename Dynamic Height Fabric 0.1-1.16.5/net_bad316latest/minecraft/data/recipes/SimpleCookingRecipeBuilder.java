...
public class SimpleCookingRecipeBuilder {
   ...
   public static SimpleCookingRecipeBuilder cooking(
      Ingredient ingredient, ItemLike itemLike, float f, int i, SimpleCookingSerializer<?> simpleCookingSerializer
   ) {
      ...
      consumer.accept(
         new SimpleCookingRecipeBuilder.Result(
            ...
            new ResourceLocation(
               resourceLocation.getNamespace(), "recipes/" + this.result.getItemCategory().getRecipeFolderName() + "/" + resourceLocation.getPath()
            ),
            this.serializer
         )
      );
