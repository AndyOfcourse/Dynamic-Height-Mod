...
public class V99 extends Schema {
   ...
   private static final Map<String, String> ITEM_TO_BLOCKENTITY = (Map<String, String>)DataFixUtils.make(Maps.newHashMap(), hashMap -> {
   ...
   protected static void registerMob(Schema schema, Map<String, Supplier<TypeTemplate>> map, String string) {
      schema.register(map, string, () -> equipment(schema));
   }
   ...
   public Map<String, Supplier<TypeTemplate>> registerEntities(Schema schema) {
      ...
      schema.register(map, "ThrownPotion", string -> DSL.optionalFields("inTile", References.BLOCK_NAME.in(schema), "Potion", References.ITEM_STACK.in(schema)));
   ...
   protected static <T> T addNames(Dynamic<T> dynamic, Map<String, String> map, String string) {
      return (T)dynamic.update(
            ...
            dynamic2 -> dynamic2.update("BlockEntityTag", dynamic2x -> {
                     ...
                     String string2 = map.get(NamespacedSchema.ensureNamespaced(stringxxx));
                     if (string2 == null) {
                  ...
                  .update(
                     ...
                     dynamic2x -> {
                        ...
                        return Objects.equals(NamespacedSchema.ensureNamespaced(string2), "minecraft:armor_stand")
