...
public class BlockEntityIdFix extends DataFix {
   private static final Map<String, String> ID_MAP = (Map<String, String>)DataFixUtils.make(Maps.newHashMap(), hashMap -> {
   ...
   public TypeRewriteRule makeRule() {
      ...
      return TypeRewriteRule.seq(
         ...
         this.fixTypeEverywhere(
            "BlockEntityIdFix", taggedChoiceType, taggedChoiceType2, dynamicOps -> pair -> pair.mapFirst(string -> ID_MAP.getOrDefault(string, string))
         )
      );
   }
}
