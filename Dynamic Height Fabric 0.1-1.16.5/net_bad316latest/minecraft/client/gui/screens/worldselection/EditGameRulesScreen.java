   ...
   public abstract class GameRuleEntry extends EditGameRulesScreen.RuleEntry {
      ...
      protected void renderLabel(PoseStack poseStack, int i, int j) {
         if (this.label.size() == 1) {
            EditGameRulesScreen.this.minecraft.font.draw(poseStack, this.label.get(0), (float)j, (float)(i + 5), 16777215);
         } else if (this.label.size() >= 2) {
            EditGameRulesScreen.this.minecraft.font.draw(poseStack, this.label.get(0), (float)j, (float)i, 16777215);
            EditGameRulesScreen.this.minecraft.font.draw(poseStack, this.label.get(1), (float)j, (float)(i + 10), 16777215);
         }
      }
   }
         ...
         GameRules.visitGameRuleTypes(
            new GameRules.GameRuleTypeVisitor() {
               ...
               public void visitBoolean(GameRules.Key<GameRules.BooleanValue> key, GameRules.Type<GameRules.BooleanValue> type) {
                  this.addEntry(
                     key, (component, list, string, booleanValue) -> EditGameRulesScreen.this.new BooleanRuleEntry(component, list, string, booleanValue)
                  );
               }
               ...
               public void visitInteger(GameRules.Key<GameRules.IntegerValue> key, GameRules.Type<GameRules.IntegerValue> type) {
                  this.addEntry(
                     key, (component, list, string, integerValue) -> EditGameRulesScreen.this.new IntegerRuleEntry(component, list, string, integerValue)
                  );
               }
               ...
               private <T extends GameRules.Value<T>> void addEntry(GameRules.Key<T> key, EditGameRulesScreen.EntryFactory<T> entryFactory) {
                  ...
                  map.computeIfAbsent(key.getCategory(), category -> Maps.newHashMap()).put(key, entryFactory.create(component, list, string3, value));
               }
            }
         );
         map.entrySet()
