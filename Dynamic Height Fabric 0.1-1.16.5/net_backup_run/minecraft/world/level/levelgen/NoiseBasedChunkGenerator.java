...
public final class NoiseBasedChunkGenerator extends ChunkGenerator {
   ...
   private int iterateNoiseColumn(int i, int j, @Nullable BlockState[] blockStates, @Nullable Predicate<BlockState> predicate) {
      ...
      double[][] ds = new double[][]{
         this.makeAndFillNoiseColumn(k, l),
         this.makeAndFillNoiseColumn(k, l + 1),
         this.makeAndFillNoiseColumn(k + 1, l),
         this.makeAndFillNoiseColumn(k + 1, l + 1)
      };
                        ...
                        for(an = an / 2.0 - an * an * an / 24.0; objectListIterator.hasNext(); an += getContribution(ao, ap, aq) * 0.8) {
                           ...
                           ap = u
                              - (
                                 boundingBox.y0
                                    + (
                                       structurePiece instanceof PoolElementStructurePiece
