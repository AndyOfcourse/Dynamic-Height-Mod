...
public enum Direction implements StringRepresentable {
   ...
   private static final Map<String, Direction> BY_NAME = Arrays.stream(VALUES).collect(Collectors.toMap(Direction::getName, direction -> direction));
   ...
   public static Direction byName(@Nullable String string) {
      return string == null ? null : BY_NAME.get(string.toLowerCase(Locale.ROOT));
   }
   ...
   public static enum Axis implements StringRepresentable, Predicate<Direction> {
      ...
      private static final Map<String, Direction.Axis> BY_NAME = Arrays.stream(VALUES).collect(Collectors.toMap(Direction.Axis::getName, axis -> axis));
      private final String name;
