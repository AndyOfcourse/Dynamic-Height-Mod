...
public abstract class Option {
   ...
   public static final ProgressOption GAMMA = new ProgressOption(
      ...
      (options, double_) -> options.gamma = double_,
      (options, progressOption) -> {
         double d = progressOption.toPct(progressOption.get(options));
         if (d == 0.0) {
            ...
            return d == 1.0
               ? progressOption.genericValueLabel(new TranslatableComponent("options.gamma.max"))
               : progressOption.percentAddValueLabel((int)(d * 100.0));
         }
      }
   );
   ...
   public static final ProgressOption SENSITIVITY = new ProgressOption(
      ...
      (options, double_) -> options.sensitivity = double_,
      (options, progressOption) -> {
         double d = progressOption.toPct(progressOption.get(options));
         if (d == 0.0) {
            ...
            return d == 1.0
               ? progressOption.genericValueLabel(new TranslatableComponent("options.sensitivity.max"))
               : progressOption.percentValueLabel(2.0 * d);
         }
      }
   );
   ...
   public static final BooleanOption HIDE_MATCHED_NAMES = new BooleanOption(
      ...
      (options, boolean_) -> options.hideMatchedNames = boolean_
   );
