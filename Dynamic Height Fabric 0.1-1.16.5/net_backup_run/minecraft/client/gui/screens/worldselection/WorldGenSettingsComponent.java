   ...
   public void init(CreateWorldScreen createWorldScreen, Minecraft minecraft, Font font) {
      ...
      this.typeButton = createWorldScreen.addButton(
         new Button(
            ...
            150,
            20,
            new TranslatableComponent("selectWorld.mapType"),
            button -> {
               while(this.preset.isPresent()) {
                  ...
                  WorldPreset worldPreset = WorldPreset.PRESETS.get(ixx);
                  this.preset = Optional.of(worldPreset);
                  this.settings = worldPreset.create(
         ...
         new Button(i, 151, 150, 20, new TranslatableComponent("selectWorld.bonusItems"), button -> {
            ...
            public Component getMessage() {
               return CommonComponents.optionStatus(
                  super.getMessage(), WorldGenSettingsComponent.this.settings.generateBonusChest() && !createWorldScreen.hardCore
               );
            }
         }
      );
            ...
            button -> {
               ...
               if (string != null) {
                  ...
                  try {
                     ...
                     minecraft.getToasts()
                        .addToast(SystemToast.multiline(minecraft, SystemToast.SystemToastIds.WORLD_GEN_SETTINGS_TRANSFER, component, component2));
                  ...
                  if (dataResult.error().isPresent()) {
                     ...
                     minecraft.getToasts()
                        .addToast(SystemToast.multiline(minecraft, SystemToast.SystemToastIds.WORLD_GEN_SETTINGS_TRANSFER, component3, component4));
                  }
