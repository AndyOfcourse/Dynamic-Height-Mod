...
public class CommandFunction {
   ...
   public static CommandFunction fromLines(
      ...
      List<CommandFunction.Entry> list2 = Lists.newArrayListWithCapacity(list.size());
      ...
      return new CommandFunction(resourceLocation, list2.toArray(new CommandFunction.Entry[0]));
   }
   ...
   public static class CacheableFunction {
      ...
      @Nullable
      public ResourceLocation getId() {
         return this.function.<ResourceLocation>map(commandFunction -> commandFunction.id).orElse(this.id);
      }
   }
