   ...
   private static void preset(
      ...
      PRESETS.add(new PresetFlatWorldScreen.PresetInfo(itemLike.asItem(), component, registry -> {
         ...
         for(StructureFeature<?> structureFeature : list) {
            map.put(structureFeature, (StructureFeatureConfiguration)StructureSettings.DEFAULTS.get(structureFeature));
         }
   ...
   class PresetsList extends ObjectSelectionList<PresetFlatWorldScreen.PresetsList.Entry> {
      ...
      public void setSelected(@Nullable PresetFlatWorldScreen.PresetsList.Entry entry) {
         ...
         if (entry != null) {
            NarratorChatListener.INSTANCE
               .sayNow(new TranslatableComponent("narrator.select", PresetFlatWorldScreen.PRESETS.get(this.children().indexOf(entry)).getName()).getString());
         }
      ...
      public class Entry extends ObjectSelectionList.Entry<PresetFlatWorldScreen.PresetsList.Entry> {
         ...
         public void render(PoseStack poseStack, int i, int j, int k, int l, int m, int n, int o, boolean bl, float f) {
            PresetFlatWorldScreen.PresetInfo presetInfo = PresetFlatWorldScreen.PRESETS.get(i);
         ...
         private void select() {
            ...
            PresetFlatWorldScreen.PresetInfo presetInfo = PresetFlatWorldScreen.PRESETS.get(PresetsList.this.children().indexOf(this));
            Registry<Biome> registry = PresetFlatWorldScreen.this.parent
               .parent
