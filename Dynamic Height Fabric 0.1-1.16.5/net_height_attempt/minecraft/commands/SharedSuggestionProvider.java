...
public interface SharedSuggestionProvider {
   ...
   static CompletableFuture<Suggestions> suggestResource(Iterable<ResourceLocation> iterable, SuggestionsBuilder suggestionsBuilder, String string) {
      ...
      filterResources(
         iterable, string2, string, resourceLocation -> resourceLocation, resourceLocation -> suggestionsBuilder.suggest(string + resourceLocation)
      );
   ...
   static <T> CompletableFuture<Suggestions> suggestResource(
      ...
      String string = suggestionsBuilder.getRemaining().toLowerCase(Locale.ROOT);
      filterResources(iterable, string, function, object -> suggestionsBuilder.suggest(function.apply(object).toString(), (Message)function2.apply(object)));
      return suggestionsBuilder.buildFuture();
   }
