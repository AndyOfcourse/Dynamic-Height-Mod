...
public abstract class WorldPreset {
   public static final WorldPreset NORMAL = new WorldPreset("default") {
      ...
      protected ChunkGenerator generator(Registry<Biome> registry, Registry<NoiseGeneratorSettings> registry2, long l) {
         return new NoiseBasedChunkGenerator(
            new OverworldBiomeSource(l, false, false, registry), l, () -> registry2.getOrThrow(NoiseGeneratorSettings.OVERWORLD)
         );
      }
   };
   ...
   private static final WorldPreset LARGE_BIOMES = new WorldPreset("large_biomes") {
      ...
      protected ChunkGenerator generator(Registry<Biome> registry, Registry<NoiseGeneratorSettings> registry2, long l) {
         return new NoiseBasedChunkGenerator(
            new OverworldBiomeSource(l, false, true, registry), l, () -> registry2.getOrThrow(NoiseGeneratorSettings.OVERWORLD)
         );
      }
   };
   public static final WorldPreset AMPLIFIED = new WorldPreset("amplified") {
      ...
      protected ChunkGenerator generator(Registry<Biome> registry, Registry<NoiseGeneratorSettings> registry2, long l) {
         return new NoiseBasedChunkGenerator(
            new OverworldBiomeSource(l, false, false, registry), l, () -> registry2.getOrThrow(NoiseGeneratorSettings.AMPLIFIED)
         );
      }
   };
   ...
   private static final WorldPreset SINGLE_BIOME_CAVES = new WorldPreset("single_biome_caves") {
      ...
      protected ChunkGenerator generator(Registry<Biome> registry, Registry<NoiseGeneratorSettings> registry2, long l) {
         return new NoiseBasedChunkGenerator(
            new FixedBiomeSource(registry.getOrThrow(Biomes.PLAINS)), l, () -> registry2.getOrThrow(NoiseGeneratorSettings.CAVES)
         );
      }
   };
   ...
   protected static final List<WorldPreset> PRESETS = Lists.newArrayList(
      new WorldPreset[]{NORMAL, FLAT, LARGE_BIOMES, AMPLIFIED, SINGLE_BIOME_SURFACE, SINGLE_BIOME_CAVES, SINGLE_BIOME_FLOATING_ISLANDS, DEBUG}
   );
   protected static final Map<Optional<WorldPreset>, WorldPreset.PresetEditor> EDITORS = ImmutableMap.of(
      Optional.of(FLAT),
      (WorldPreset.PresetEditor)(createWorldScreen, worldGenSettings) -> {
      ...
      (WorldPreset.PresetEditor)(createWorldScreen, worldGenSettings) -> new CreateBuffetWorldScreen(
            createWorldScreen,
            createWorldScreen.worldGenSettingsComponent.registryHolder(),
            biome -> createWorldScreen.worldGenSettingsComponent
                  .updateSettings(
                     fromBuffetSettings(createWorldScreen.worldGenSettingsComponent.registryHolder(), worldGenSettings, SINGLE_BIOME_SURFACE, biome)
                  ),
      ...
      (WorldPreset.PresetEditor)(createWorldScreen, worldGenSettings) -> new CreateBuffetWorldScreen(
            ...
            biome -> createWorldScreen.worldGenSettingsComponent
                  .updateSettings(
                     fromBuffetSettings(createWorldScreen.worldGenSettingsComponent.registryHolder(), worldGenSettings, SINGLE_BIOME_FLOATING_ISLANDS, biome)
                  ),
            parseBuffetSettings(createWorldScreen.worldGenSettingsComponent.registryHolder(), worldGenSettings)
         )
   );
   ...
   private static Biome parseBuffetSettings(RegistryAccess registryAccess, WorldGenSettings worldGenSettings) {
      return worldGenSettings.overworld()
         .getBiomeSource()
         .possibleBiomes()
         .stream()
         .findFirst()
