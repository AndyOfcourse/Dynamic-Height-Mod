...
public final class NbtUtils {
               ...
               for(int i = 0; i < listTag.size(); ++i) {
                  ...
                  if (compoundTag3.contains("Signature", 8)) {
                     gameProfile.getProperties()
                        .put(string2, new com.mojang.authlib.properties.Property(string2, string3, compoundTag3.getString("Signature")));
                  } else {
   ...
   public static CompoundTag writeBlockState(BlockState blockState) {
      ...
      if (!immutableMap.isEmpty()) {
         ...
         while(var4.hasNext()) {
            Entry<Property<?>, Comparable<?>> entry = (Entry)var4.next();
