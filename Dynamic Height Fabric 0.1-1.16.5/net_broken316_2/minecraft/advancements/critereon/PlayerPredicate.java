...
public class PlayerPredicate {
   ...
   public boolean matches(Entity entity) {
      if (this == ANY) {
         ...
         if (!this.level.matches(serverPlayer.experienceLevel)) {
            ...
            while(var11.hasNext()) {
               it.unimi.dsi.fastutil.objects.Object2BooleanMap.Entry<ResourceLocation> entry2 = (it.unimi.dsi.fastutil.objects.Object2BooleanMap.Entry)var11.next(
   ...
   static class AdvancementCriterionsPredicate implements PlayerPredicate.AdvancementPredicate {
      ...
      public boolean test(AdvancementProgress advancementProgress) {
         ...
         while(var2.hasNext()) {
            it.unimi.dsi.fastutil.objects.Object2BooleanMap.Entry<String> entry = (it.unimi.dsi.fastutil.objects.Object2BooleanMap.Entry)var2.next();
