...
extends DataFix {
    ...
    private static <T> Map<Dynamic<T>, Dynamic<T>> fixFlatStructures(DynamicOps<T> dynamicOps, OptionalDynamic<T> optionalDynamic) {
        ...
        if (!optionalDynamic.result().isPresent()) {
            ...
            map.put("minecraft:village", DEFAULTS.get((Object)"minecraft:village"));
        }
            ...
            switch (string2) {
                ...
                case "separation": {
                    if ("oceanmonument".equals(string)) {
                        StructureFeatureConfiguration structureFeatureConfiguration = (StructureFeatureConfiguration)map.getOrDefault("minecraft:monument", DEFAULTS.get((Object)"minecraft:monument"));
