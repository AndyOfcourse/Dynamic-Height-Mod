...
extends EntityRenameFix {
    ...
    protected Pair<String, Typed<?>> fix(String string, Typed<?> typed) {
        ...
        if (Objects.equals("EntityHorse", string)) {
            ...
            return Pair.of((Object)string2, (Object)((Pair)typed.write().flatMap(arg_0 -> ((Type)type).readTyped(arg_0)).result().orElseThrow(() -> new IllegalStateException("Could not parse the new horse"))).getFirst());
        }
