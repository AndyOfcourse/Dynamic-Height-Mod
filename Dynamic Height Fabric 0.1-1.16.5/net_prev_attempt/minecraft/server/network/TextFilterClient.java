...
implements AutoCloseable {
    ...
    implements TextFilter {
        ...
        public CompletableFuture<Optional<List<String>>> processMessageBundle(List<String> list2) {
            List list22 = (List)list2.stream().map(string -> TextFilterClient.this.requestMessageProcessing(this.profile, string, TextFilterClient.this.chatIgnoreStrategy, this.streamExecutor)).collect(ImmutableList.toImmutableList());
