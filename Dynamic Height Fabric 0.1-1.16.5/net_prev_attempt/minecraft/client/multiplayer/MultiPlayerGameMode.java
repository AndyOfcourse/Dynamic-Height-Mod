...
public class MultiPlayerGameMode {
               ...
               this.minecraft
                  ...
                  .play(
                     new SimpleSoundInstance(
                        soundType.getHitSound(), SoundSource.BLOCKS, (soundType.getVolume() + 1.0F) / 8.0F, soundType.getPitch() * 0.5F, blockPos
                     )
                  );
            }
   ...
   public void handleBlockBreakAck(ClientLevel clientLevel, BlockPos blockPos, BlockState blockState, ServerboundPlayerActionPacket.Action action, boolean bl) {
      Vec3 vec3 = (Vec3)this.unAckedActions.remove(Pair.of(blockPos, action));
      ...
      while(this.unAckedActions.size() >= 50) {
         Pair<BlockPos, ServerboundPlayerActionPacket.Action> pair = (Pair)this.unAckedActions.firstKey();
