...
public class Commands {
    ...
    public Commands(CommandSelection commandSelection) {
        ...
        this.dispatcher.setConsumer((commandContext, bl, i) -> ((CommandSourceStack)commandContext.getSource()).onCommandComplete((CommandContext<CommandSourceStack>)commandContext, bl, i));
    }
