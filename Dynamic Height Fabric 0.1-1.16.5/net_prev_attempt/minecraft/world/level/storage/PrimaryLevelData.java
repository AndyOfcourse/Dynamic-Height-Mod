...
WorldData {
    ...
    private void setTagData(RegistryAccess registryAccess, CompoundTag compoundTag, @Nullable CompoundTag compoundTag2) {
        ...
        WorldGenSettings.CODEC.encodeStart(registryWriteOps, (Object)this.worldGenSettings).resultOrPartial(Util.prefix("WorldGenSettings: ", arg_0 -> ((Logger)LOGGER).error(arg_0))).ifPresent(tag -> compoundTag.put("WorldGenSettings", (Tag)tag));
