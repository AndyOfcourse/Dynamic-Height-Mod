...
public abstract class Biomes {
   ...
   public static ResourceKey<Biome> byId(int i) {
      return (ResourceKey<Biome>)TO_NAME.get(i);
   }
   ...
   static {
      ...
      register(
         131, net.minecraft.world.level.biome.Biomes.GRAVELLY_MOUNTAINS, VanillaBiomes.mountainBiome(1.0F, 0.5F, SurfaceBuilders.GRAVELLY_MOUNTAIN, false)
      );
      ...
      register(
         162,
         net.minecraft.world.level.biome.Biomes.MODIFIED_GRAVELLY_MOUNTAINS,
         VanillaBiomes.mountainBiome(1.0F, 0.5F, SurfaceBuilders.GRAVELLY_MOUNTAIN, false)
      );
