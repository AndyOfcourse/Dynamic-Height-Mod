   ...
   public void drawHover(PoseStack poseStack, int i, int j, float f, int k, int l) {
      ...
      if (bl2) {
         for(int s = 0; s < this.description.size(); ++s) {
            this.minecraft.font.draw(poseStack, this.description.get(s), (float)(q + 5), (float)(p + 26 - r + 7 + s * 9), -5592406);
         }
      } else {
         for(int s = 0; s < this.description.size(); ++s) {
            this.minecraft.font.draw(poseStack, this.description.get(s), (float)(q + 5), (float)(j + this.y + 9 + 17 + s * 9), -5592406);
         }
      }
