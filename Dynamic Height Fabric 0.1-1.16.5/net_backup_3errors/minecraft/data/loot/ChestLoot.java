         ...
         LootTable.lootTable()
            ...
            .withPool(
               LootPool.lootPool()
                  .setRolls(RandomValueBounds.between(3.0F, 4.0F))
                  .add(
                     LootItem.lootTableItem(Blocks.GILDED_BLACKSTONE).setWeight(2).apply(SetItemCountFunction.setCount(RandomValueBounds.between(1.0F, 5.0F)))
                  )
         ...
         LootTable.lootTable()
            ...
            .withPool(
               LootPool.lootPool()
                  ...
                  .add(
                     LootItem.lootTableItem(Items.PRISMARINE_CRYSTALS).setWeight(5).apply(SetItemCountFunction.setCount(RandomValueBounds.between(1.0F, 5.0F)))
                  )
            )
            .withPool(
               LootPool.lootPool()
               ...
               LootPool.lootPool()
                  ...
                  .add(
                     LootItem.lootTableItem(Items.GLISTERING_MELON_SLICE)
                        .setWeight(5)
                        .apply(SetItemCountFunction.setCount(RandomValueBounds.between(4.0F, 12.0F)))
                  )
