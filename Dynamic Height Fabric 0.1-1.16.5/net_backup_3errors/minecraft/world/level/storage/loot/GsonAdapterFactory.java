...
public class GsonAdapterFactory {
   ...
   static class JsonAdapter<E, T extends SerializerType<E>> implements JsonDeserializer<E>, JsonSerializer<E> {
      ...
      private JsonAdapter(
         ...
         @Nullable Pair<T, GsonAdapterFactory.DefaultSerializer<? extends E>> pair
      ) {
         this.registry = registry;
         this.elementName = string;
         this.typeKey = string2;
      ...
      public E deserialize(JsonElement jsonElement, Type type, JsonDeserializationContext jsonDeserializationContext) throws JsonParseException {
         if (jsonElement.isJsonObject()) {
            ...
            return (E)((GsonAdapterFactory.DefaultSerializer)this.defaultType.getSecond()).deserialize(jsonElement, jsonDeserializationContext);
         }
      }
      ...
      public JsonElement serialize(E object, Type type, JsonSerializationContext jsonSerializationContext) {
         ...
         if (this.defaultType != null && this.defaultType.getFirst() == serializerType) {
            return ((GsonAdapterFactory.DefaultSerializer)this.defaultType.getSecond()).serialize((T)object, jsonSerializationContext);
