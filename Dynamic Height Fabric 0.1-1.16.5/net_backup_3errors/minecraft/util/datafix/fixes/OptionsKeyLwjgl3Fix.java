...
public class OptionsKeyLwjgl3Fix extends DataFix {
   private static final Int2ObjectMap<String> MAP = (Int2ObjectMap<String>)DataFixUtils.make(new Int2ObjectOpenHashMap(), int2ObjectOpenHashMap -> {
   ...
   public TypeRewriteRule makeRule() {
      return this.fixTypeEverywhereTyped(
         ...
         typed -> typed.update(
               DSL.remainderFinder(), dynamic -> (Dynamic)dynamic.getMapValues().map(map -> dynamic.createMap(map.entrySet().stream().map(entry -> {
