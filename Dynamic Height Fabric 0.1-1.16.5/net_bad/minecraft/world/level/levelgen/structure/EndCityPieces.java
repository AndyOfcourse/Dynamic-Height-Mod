...
public class EndCityPieces {
   ...
   private static final EndCityPieces.SectionGenerator TOWER_GENERATOR = new EndCityPieces.SectionGenerator() {
      ...
      public boolean generate(
         ...
         EndCityPieces.EndCityPiece endCityPiece2 = EndCityPieces.addHelper(
            list,
            EndCityPieces.addPiece(structureManager, endCityPiece, new BlockPos(3 + random.nextInt(2), -3, 3 + random.nextInt(2)), "tower_base", rotation, true)
         );
         endCityPiece2 = EndCityPieces.addHelper(
            list, EndCityPieces.addPiece(structureManager, endCityPiece2, new BlockPos(0, 7, 0), "tower_piece", rotation, true)
         );
   ...
   private static final EndCityPieces.SectionGenerator TOWER_BRIDGE_GENERATOR = new EndCityPieces.SectionGenerator() {
      ...
      public boolean generate(
         ...
         if (!this.shipCreated && random.nextInt(10 - i) == 0) {
            EndCityPieces.addHelper(
               ...
               EndCityPieces.addPiece(
                  structureManager, endCityPiece2, new BlockPos(-8 + random.nextInt(8), k, -70 + random.nextInt(10)), "ship", rotation, true
               )
            );
         ...
         endCityPiece2 = EndCityPieces.addHelper(
            list,
            EndCityPieces.addPiece(structureManager, endCityPiece2, new BlockPos(4, k, 0), "bridge_end", rotation.getRotated(Rotation.CLOCKWISE_180), true)
         );
         endCityPiece2.genDepth = -1;
         return true;
      }
