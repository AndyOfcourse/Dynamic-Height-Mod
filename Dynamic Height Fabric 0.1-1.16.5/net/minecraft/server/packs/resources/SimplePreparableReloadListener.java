...
public abstract class SimplePreparableReloadListener<T> implements PreparableReloadListener {
   ...
   public final CompletableFuture<Void> reload(
      ...
      return CompletableFuture.<T>supplyAsync(() -> this.prepare(resourceManager, profilerFiller), executor)
         .thenCompose(preparationBarrier::wait)
         .thenAcceptAsync(object -> this.apply(object, resourceManager, profilerFiller2), executor2);
   }
