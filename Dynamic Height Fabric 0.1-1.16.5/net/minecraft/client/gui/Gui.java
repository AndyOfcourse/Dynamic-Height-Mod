...
public class Gui extends GuiComponent {
   ...
   public Gui(Minecraft minecraft) {
      ...
      this.chatListeners.get(ChatType.CHAT).add(new StandardChatListener(minecraft));
      this.chatListeners.get(ChatType.CHAT).add(chatListener);
      this.chatListeners.get(ChatType.SYSTEM).add(new StandardChatListener(minecraft));
   ...
   private void displayScoreboardSidebar(PoseStack poseStack, Objective objective) {
      ...
      List<Pair<Score, Component>> list2 = Lists.newArrayListWithCapacity(collection.size());
