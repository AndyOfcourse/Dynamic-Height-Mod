...
public class LootContext {
   ...
   public void addDynamicDrops(ResourceLocation resourceLocation, Consumer<ItemStack> consumer) {
      LootContext.DynamicDrop dynamicDrop = this.dynamicDrops.get(resourceLocation);
      if (dynamicDrop != null) {
   ...
   public static class Builder {
      ...
      public LootContext.Builder withDynamicDrop(ResourceLocation resourceLocation, LootContext.DynamicDrop dynamicDrop) {
         LootContext.DynamicDrop dynamicDrop2 = this.dynamicDrops.put(resourceLocation, dynamicDrop);
      ...
      public LootContext create(LootContextParamSet lootContextParamSet) {
         ...
         if (!set.isEmpty()) {
            ...
            Set<LootContextParam<?>> set2 = Sets.difference(lootContextParamSet.getRequired(), this.params.keySet());
            if (!set2.isEmpty()) {
               ...
               return new LootContext(
                  ...
                  this.luck,
                  this.level,
                  minecraftServer.getLootTables()::get,
