...
public class Features {
   ...
   public static final ConfiguredFeature<?, ?> GLOWSTONE_EXTRA = register(
      "glowstone_extra",
      Feature.GLOWSTONE_BLOB.configured(FeatureConfiguration.NONE).decorated(FeatureDecorator.GLOWSTONE.configured(new CountConfiguration(10)))
   );
   ...
   public static final ConfiguredFeature<?, ?> SEAGRASS_COLD = register(
      "seagrass_cold",
      Feature.SEAGRASS.configured(new ProbabilityFeatureConfiguration(0.3F)).count(32).decorated(Features.Decorators.TOP_SOLID_HEIGHTMAP_SQUARE)
   );
   ...
   public static final ConfiguredFeature<?, ?> SEAGRASS_RIVER = register(
      "seagrass_river",
      Feature.SEAGRASS.configured(new ProbabilityFeatureConfiguration(0.4F)).count(48).decorated(Features.Decorators.TOP_SOLID_HEIGHTMAP_SQUARE)
   );
   public static final ConfiguredFeature<?, ?> SEAGRASS_DEEP = register(
      "seagrass_deep",
      Feature.SEAGRASS.configured(new ProbabilityFeatureConfiguration(0.8F)).count(48).decorated(Features.Decorators.TOP_SOLID_HEIGHTMAP_SQUARE)
   );
   public static final ConfiguredFeature<?, ?> SEAGRASS_SWAMP = register(
      "seagrass_swamp",
      Feature.SEAGRASS.configured(new ProbabilityFeatureConfiguration(0.6F)).count(64).decorated(Features.Decorators.TOP_SOLID_HEIGHTMAP_SQUARE)
   );
   public static final ConfiguredFeature<?, ?> SEAGRASS_WARM = register(
      "seagrass_warm",
      Feature.SEAGRASS.configured(new ProbabilityFeatureConfiguration(0.3F)).count(80).decorated(Features.Decorators.TOP_SOLID_HEIGHTMAP_SQUARE)
   );
   ...
   public static final ConfiguredFeature<?, ?> PILE_ICE = register(
      "pile_ice",
      Feature.BLOCK_PILE
         .configured(new BlockPileConfiguration(new WeightedStateProvider().add(Features.States.BLUE_ICE, 1).add(Features.States.PACKED_ICE, 5)))
   );
   ...
   public static final ConfiguredFeature<?, ?> PATCH_GRASS_FOREST = register(
      "patch_grass_forest",
      Feature.RANDOM_PATCH.configured(Features.Configs.DEFAULT_GRASS_CONFIG).decorated(Features.Decorators.HEIGHTMAP_DOUBLE_SQUARE).count(2)
   );
   ...
   public static final ConfiguredFeature<?, ?> PATCH_GRASS_NORMAL = register(
      "patch_grass_normal",
      Feature.RANDOM_PATCH.configured(Features.Configs.DEFAULT_GRASS_CONFIG).decorated(Features.Decorators.HEIGHTMAP_DOUBLE_SQUARE).count(5)
   );
   ...
   public static final ConfiguredFeature<?, ?> PATCH_GRASS_JUNGLE = register(
      "patch_grass_jungle",
      Feature.RANDOM_PATCH.configured(Features.Configs.JUNGLE_GRASS_CONFIG).decorated(Features.Decorators.HEIGHTMAP_DOUBLE_SQUARE).count(25)
   );
   ...
   public static final ConfiguredFeature<?, ?> PATCH_WATERLILLY = register(
      ...
      Feature.RANDOM_PATCH
         .configured(
            new RandomPatchConfiguration.GrassConfigurationBuilder(new SimpleStateProvider(Features.States.LILY_PAD), SimpleBlockPlacer.INSTANCE)
               .tries(10)
               .build()
         )
         .decorated(Features.Decorators.HEIGHTMAP_DOUBLE_SQUARE)
   ...
   public static final ConfiguredFeature<?, ?> ORE_DIRT = register(
      "ore_dirt",
      Feature.ORE.configured(new OreConfiguration(OreConfiguration.Predicates.NATURAL_STONE, Features.States.DIRT, 33)).range(256).squared().count(10)
   );
   ...
   public static final ConfiguredFeature<?, ?> ORE_DIAMOND = register(
      "ore_diamond",
      Feature.ORE.configured(new OreConfiguration(OreConfiguration.Predicates.NATURAL_STONE, Features.States.DIAMOND_ORE, 8)).range(16).squared()
   );
   ...
   public static final ConfiguredFeature<?, ?> FLOWER_SWAMP = register(
      ...
      Feature.FLOWER
         .configured(
            new RandomPatchConfiguration.GrassConfigurationBuilder(new SimpleStateProvider(Features.States.BLUE_ORCHID), SimpleBlockPlacer.INSTANCE)
               .tries(64)
               .build()
         )
         .decorated(Features.Decorators.ADD_32)
   ...
   private static final ImmutableList<Supplier<ConfiguredFeature<?, ?>>> FOREST_FLOWER_FEATURES = ImmutableList.of(
      (Supplier<ConfiguredFeature<RandomPatchConfiguration, ?>>)() -> Feature.RANDOM_PATCH
            .configured(
      ...
      (Supplier<ConfiguredFeature<RandomPatchConfiguration, ?>>)() -> Feature.NO_BONEMEAL_FLOWER
            .configured(
         ...
         .configured(
            new RandomFeatureConfiguration(
               ImmutableList.of(
                  ...
                  DARK_OAK.weighted(0.6666667F),
                  BIRCH.weighted(0.2F),
                  FANCY_OAK.weighted(0.1F)
               ),
               OAK
            )
         )
      ...
      Feature.SIMPLE_RANDOM_SELECTOR
         .configured(
            new SimpleRandomFeatureConfiguration(
               ImmutableList.of(
                  (Supplier<ConfiguredFeature<NoneFeatureConfiguration, ?>>)() -> Feature.CORAL_TREE.configured(FeatureConfiguration.NONE),
                  (Supplier<ConfiguredFeature<NoneFeatureConfiguration, ?>>)() -> Feature.CORAL_CLAW.configured(FeatureConfiguration.NONE),
                  (Supplier<ConfiguredFeature<NoneFeatureConfiguration, ?>>)() -> Feature.CORAL_MUSHROOM.configured(FeatureConfiguration.NONE)
               )
            )
         )
         .decorated(Features.Decorators.TOP_SOLID_HEIGHTMAP)
   ...
   public static final ConfiguredFeature<?, ?> TREES_GIANT = register(
      ...
      Feature.RANDOM_SELECTOR
         .configured(
            new RandomFeatureConfiguration(
               ImmutableList.of(MEGA_SPRUCE.weighted(0.025641026F), MEGA_PINE.weighted(0.30769232F), PINE.weighted(0.33333334F)), SPRUCE
            )
         )
         .decorated(Features.Decorators.HEIGHTMAP_SQUARE)
         .decorated(FeatureDecorator.COUNT_EXTRA.configured(new FrequencyWithExtraChanceDecoratorConfiguration(10, 0.1F, 1)))
   ...
   public static final ConfiguredFeature<?, ?> TREES_JUNGLE = register(
      ...
      Feature.RANDOM_SELECTOR
         .configured(
            new RandomFeatureConfiguration(
               ImmutableList.of(FANCY_OAK.weighted(0.1F), JUNGLE_BUSH.weighted(0.5F), MEGA_JUNGLE_TREE.weighted(0.33333334F)), JUNGLE_TREE
            )
         )
         .decorated(Features.Decorators.HEIGHTMAP_SQUARE)
   ...
   public static final class States {
      ...
      protected static final BlockState HUGE_RED_MUSHROOM = Blocks.RED_MUSHROOM_BLOCK
         .defaultBlockState()
