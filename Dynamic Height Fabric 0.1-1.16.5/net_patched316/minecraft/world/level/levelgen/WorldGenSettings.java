...
public class WorldGenSettings {
   ...
   public static WorldGenSettings makeDefault(Registry<DimensionType> registry, Registry<Biome> registry2, Registry<NoiseGeneratorSettings> registry3) {
      ...
      return new WorldGenSettings(
         ...
         true,
         false,
         withOverworld(registry, DimensionType.defaultDimensions(registry, registry2, registry3, l), makeDefaultOverworld(registry2, registry3, l))
      );
   }
            ...
            return new WorldGenSettings(
               ...
               withOverworld(
                  ...
                  new NoiseBasedChunkGenerator(
                     new OverworldBiomeSource(l, false, false, registry2), l, () -> registry3.getOrThrow(NoiseGeneratorSettings.AMPLIFIED)
                  )
               )
            );
         case "largebiomes":
            return new WorldGenSettings(
               ...
               withOverworld(
                  ...
                  mappedRegistry,
                  new NoiseBasedChunkGenerator(
                     new OverworldBiomeSource(l, false, true, registry2), l, () -> registry3.getOrThrow(NoiseGeneratorSettings.OVERWORLD)
                  )
               )
            );
         default:
      ...
      if (optionalLong.isPresent()) {
         ...
         for(Entry<ResourceKey<LevelStem>, LevelStem> entry : this.dimensions.entrySet()) {
            ...
            mappedRegistry.register(
               resourceKey,
               new LevelStem(entry.getValue().typeSupplier(), entry.getValue().generator().withSeed(m)),
