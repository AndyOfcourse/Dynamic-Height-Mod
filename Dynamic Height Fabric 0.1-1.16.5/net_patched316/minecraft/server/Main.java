      ...
      try {
         ...
         if (worldData == null) {
            ...
            if (optionSet.has(optionSpec3)) {
               ...
               worldGenSettings = optionSet.has(optionSpec4)
                  ? dedicatedServerProperties.worldGenSettings.withBonusChest()
         ...
         final DedicatedServer dedicatedServer = MinecraftServer.spin(
            threadx -> {
               ...
               dedicatedServerxx.setSingleplayerName((String)optionSet.valueOf(optionSpec9));
               dedicatedServerxx.setPort(optionSet.valueOf(optionSpec12));
               dedicatedServerxx.setDemo(optionSet.has(optionSpec3));
               dedicatedServerxx.setId((String)optionSet.valueOf(optionSpec13));
