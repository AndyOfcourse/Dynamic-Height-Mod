...
public class WorldGenSettingsFix extends DataFix {
         ...
         switch(bl6) {
                     ...
                     dynamic.createMap(
                        ImmutableMap.of(
                           ...
                           optionalDynamic.get("layers")
                              .result()
                              .orElseGet(() -> dynamic.createList(Stream.of(
                                          dynamic.createMap(
                                             ImmutableMap.of(
            ...
            case "buffet":
               ...
               Dynamic<T> dynamic4 = (Dynamic)optionalDynamic2.get("biome_source")
                  .result()
                  .orElseGet(() -> (T)dynamic.createMap(ImmutableMap.of(dynamic.createString("type"), dynamic.createString("minecraft:fixed"))));
               Dynamic<T> dynamic5;
               if (dynamic4.get("type").asString().result().equals(Optional.of("minecraft:fixed"))) {
                  String string = dynamic4.get("options")
                     .get("biomes")
                     .asStream()
                     .findFirst()
   ...
   private static void setSpacing(Map<String, WorldGenSettingsFix.StructureFeatureConfiguration> map, String string, String string2, int i) {
      WorldGenSettingsFix.StructureFeatureConfiguration structureFeatureConfiguration = map.getOrDefault(
         string, (WorldGenSettingsFix.StructureFeatureConfiguration)DEFAULTS.get(string)
      );
