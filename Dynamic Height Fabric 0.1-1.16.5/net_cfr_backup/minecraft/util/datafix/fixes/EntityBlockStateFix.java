...
extends DataFix {
    ...
    public TypeRewriteRule makeRule() {
        ...
        Type type = DSL.and((Type)DSL.optional((Type)DSL.field((String)"inTile", (Type)DSL.named((String)References.BLOCK_NAME.typeName(), (Type)DSL.or((Type)DSL.intType(), (Type)NamespacedSchema.namespacedString())))), (Type)DSL.remainderType());
    ...
    private Typed<?> updateFallingBlock(Typed<?> typed) {
        Type type = DSL.optional((Type)DSL.field((String)"Block", (Type)DSL.named((String)References.BLOCK_NAME.typeName(), (Type)DSL.or((Type)DSL.intType(), (Type)NamespacedSchema.namespacedString()))));
        ...
        return typed.update(type.finder(), type2, either -> {
            ...
            return Either.left((Object)Pair.of((Object)References.BLOCK_STATE.typeName(), (Object)BlockStateData.getTag((int)(i << 4 | j))));
    ...
    private Typed<?> updateBlockToBlockState(Typed<?> typed, String string, String string2, String string3) {
        Tag.TagType type = DSL.field((String)string, (Type)DSL.named((String)References.BLOCK_NAME.typeName(), (Type)DSL.or((Type)DSL.intType(), (Type)NamespacedSchema.namespacedString())));
        ...
        return typed.update(type.finder(), (Type)type2, pair -> {
            ...
            return Pair.of((Object)References.BLOCK_STATE.typeName(), (Object)BlockStateData.getTag((int)(i << 4 | j)));
