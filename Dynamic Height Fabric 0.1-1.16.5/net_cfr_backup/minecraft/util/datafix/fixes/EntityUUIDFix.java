...
extends AbstractUUIDFix {
    ...
    private static Dynamic<?> updatePiglin(Dynamic<?> dynamic2) {
        return dynamic2.update("Brain", dynamic -> dynamic.update("memories", dynamic2 -> dynamic2.update("minecraft:angry_at", dynamic -> EntityUUIDFix.replaceUUIDString((Dynamic)dynamic, (String)"value", (String)"value").orElseGet(() -> {
    ...
    private static Dynamic<?> updateEvokerFangs(Dynamic<?> dynamic) {
        return EntityUUIDFix.replaceUUIDLeastMost(dynamic, (String)"OwnerUUID", (String)"Owner").orElse(dynamic);
    }

    private static Dynamic<?> updateZombieVillager(Dynamic<?> dynamic) {
        return EntityUUIDFix.replaceUUIDLeastMost(dynamic, (String)"ConversionPlayer", (String)"ConversionPlayer").orElse(dynamic);
    }
    ...
    private static Dynamic<?> updateShulkerBullet(Dynamic<?> dynamic) {
        dynamic = EntityUUIDFix.replaceUUIDMLTag(dynamic, (String)"Owner", (String)"Owner").orElse(dynamic);
        return EntityUUIDFix.replaceUUIDMLTag(dynamic, (String)"Target", (String)"Target").orElse(dynamic);
    }

    private static Dynamic<?> updateItem(Dynamic<?> dynamic) {
        dynamic = EntityUUIDFix.replaceUUIDMLTag(dynamic, (String)"Owner", (String)"Owner").orElse(dynamic);
        return EntityUUIDFix.replaceUUIDMLTag(dynamic, (String)"Thrower", (String)"Thrower").orElse(dynamic);
    }

    private static Dynamic<?> updateFox(Dynamic<?> dynamic) {
        Optional<Dynamic> optional = dynamic.get("TrustedUUIDs").result().map(dynamic22 -> dynamic.createList(dynamic22.asStream().map(dynamic -> EntityUUIDFix.createUUIDFromML((Dynamic)dynamic).orElseGet(() -> {
    ...
    private static Dynamic<?> updateHurtBy(Dynamic<?> dynamic) {
        return EntityUUIDFix.replaceUUIDString(dynamic, (String)"HurtBy", (String)"HurtBy").orElse(dynamic);
    }

    private static Dynamic<?> updateAnimalOwner(Dynamic<?> dynamic) {
        Dynamic<?> dynamic2 = EntityUUIDFix.updateAnimal(dynamic);
        return EntityUUIDFix.replaceUUIDString(dynamic2, (String)"OwnerUUID", (String)"Owner").orElse(dynamic2);
    }

    private static Dynamic<?> updateAnimal(Dynamic<?> dynamic) {
        Dynamic<?> dynamic2 = EntityUUIDFix.updateMob(dynamic);
        return EntityUUIDFix.replaceUUIDLeastMost(dynamic2, (String)"LoveCause", (String)"LoveCause").orElse(dynamic2);
    }

    private static Dynamic<?> updateMob(Dynamic<?> dynamic2) {
        return EntityUUIDFix.updateLivingEntity(dynamic2).update("Leash", dynamic -> EntityUUIDFix.replaceUUIDLeastMost((Dynamic)dynamic, (String)"UUID", (String)"UUID").orElse(dynamic));
    }

    public static Dynamic<?> updateLivingEntity(Dynamic<?> dynamic) {
        return dynamic.update("Attributes", dynamic22 -> dynamic.createList(dynamic22.asStream().map(dynamic -> dynamic.update("Modifiers", dynamic22 -> dynamic.createList(dynamic22.asStream().map(dynamic -> EntityUUIDFix.replaceUUIDLeastMost((Dynamic)dynamic, (String)"UUID", (String)"UUID").orElse(dynamic)))))));
    }
    ...
    public static Dynamic<?> updateEntityUUID(Dynamic<?> dynamic) {
        return EntityUUIDFix.replaceUUIDLeastMost(dynamic, (String)"UUID", (String)"UUID").orElse(dynamic);
    }
