...
public class Scoreboard {
    ...
    public Score getOrCreatePlayerScore(String string2, Objective objective2) {
        ...
        return map.computeIfAbsent(objective2, objective -> {
            Score score = new Score(this, objective, string2);
            score.setScore(0);
            return score;
        });
    }
    ...
    public Map<Objective, Score> getPlayerScores(String string) {
        HashMap map = this.playerScores.get(string);
        if (map == null) {
            map = Maps.newHashMap();
        }
        return map;
    ...
    public static String getDisplaySlotName(int i) {
        ...
        if (i >= 3 && i <= 18 && (chatFormatting = ChatFormatting.getById((int)(i - 3))) != null && chatFormatting != ChatFormatting.RESET) {
    ...
    public static int getDisplaySlotByName(String string) {
        ...
        if (string.startsWith("sidebar.team.") && (chatFormatting = ChatFormatting.getByName((String)(string2 = string.substring("sidebar.team.".length())))) != null && chatFormatting.getId() >= 0) {
