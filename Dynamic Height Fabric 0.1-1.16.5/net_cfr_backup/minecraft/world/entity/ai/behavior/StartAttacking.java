...
extends Behavior<E> {
    ...
    public StartAttacking(Predicate<E> predicate, Function<E, Optional<? extends LivingEntity>> function) {
        super((Map)ImmutableMap.of((Object)MemoryModuleType.ATTACK_TARGET, (Object)MemoryStatus.VALUE_ABSENT, (Object)MemoryModuleType.CANT_REACH_WALK_TARGET_SINCE, (Object)MemoryStatus.REGISTERED));
    ...
    private void setAttackTarget(E mob, LivingEntity livingEntity) {
        mob.getBrain().setMemory(MemoryModuleType.ATTACK_TARGET, (Object)livingEntity);
