...
extends LootItemConditionalFunction {
    ...
    public Set<LootContextParam<?>> getReferencedContextParams() {
        return this.resolutionContext != null ? ImmutableSet.of((Object)this.resolutionContext.getParam()) : ImmutableSet.of();
    }
    ...
    public ItemStack run(ItemStack itemStack, LootContext lootContext) {
        ...
        if (listTag != null) {
            ...
            UnaryOperator unaryOperator = SetNameFunction.createResolver((LootContext)lootContext, (LootContext.EntityTarget)this.resolutionContext);
            this.lore.stream().map(unaryOperator).map(Component.Serializer::toJson).map(StringTag::valueOf).forEach(arg_0 -> listTag.add(arg_0));
        }
        return itemStack;
    }
    ...
    private ListTag getLoreTag(ItemStack itemStack, boolean bl) {
        ...
        if (compoundTag.contains("display", 10)) {
            ...
            compoundTag.put("display", (Tag)compoundTag2);
        } else {
            return null;
        }
        ...
        if (bl) {
            ...
            compoundTag2.put("Lore", (Tag)listTag);
            return listTag;
        }
        return null;
    }

    static /* synthetic */ boolean method_15961(SetLoreFunction setLoreFunction) {
        return setLoreFunction.replace;
    }

    static /* synthetic */ List method_15963(SetLoreFunction setLoreFunction) {
        return setLoreFunction.lore;
    }

    static /* synthetic */ LootContext.EntityTarget method_15967(SetLoreFunction setLoreFunction) {
