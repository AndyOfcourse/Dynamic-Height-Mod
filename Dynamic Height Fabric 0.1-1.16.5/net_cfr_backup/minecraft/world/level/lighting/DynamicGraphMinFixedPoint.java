...
public abstract class DynamicGraphMinFixedPoint {
    ...
    protected DynamicGraphMinFixedPoint(int i, int j, int k) {
        ...
        for (int l = 0; l < i; ++l) {
            this.queues[l] = new /* Unavailable Anonymous Inner Class!! */;
        }
        this.computedLevels = new /* Unavailable Anonymous Inner Class!! */;
    ...
    private void checkEdge(long l, long m, int i, int j, int k, boolean bl) {
        ...
        i = Mth.clamp((int)i, (int)0, (int)(this.levelCount - 1));
        j = Mth.clamp((int)j, (int)0, (int)(this.levelCount - 1));
        if (k == 255) {
            bl2 = true;
            k = j;
        } else {
        ...
        int n = bl ? Math.min(k, i) : Mth.clamp((int)this.getComputedLevel(m, l, i), (int)0, (int)(this.levelCount - 1));
    ...
    protected final void checkNeighbor(long l, long m, int i, boolean bl) {
        ...
        int k = Mth.clamp((int)this.computeLevelFromNeighbor(l, m, i), (int)0, (int)(this.levelCount - 1));
        if (bl) {
            ...
            if (j == 255) {
                bl2 = true;
                n = Mth.clamp((int)this.getLevel(m), (int)0, (int)(this.levelCount - 1));
            } else {
                n = j;
                bl2 = false;
            }
    ...
    protected final int runUpdates(int i) {
        ...
        while (this.firstQueuedLevel < this.levelCount && i > 0) {
            ...
            int j = Mth.clamp((int)this.getLevel(l), (int)0, (int)(this.levelCount - 1));
