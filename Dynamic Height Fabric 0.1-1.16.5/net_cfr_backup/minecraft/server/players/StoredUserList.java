...
public abstract class StoredUserList<K, V extends StoredUserEntry<K>> {
    ...
    public void save() throws IOException {
        ...
        this.map.values().stream().map(storedUserEntry -> (JsonObject)Util.make((Object)new JsonObject(), arg_0 -> ((StoredUserEntry)storedUserEntry).serialize(arg_0))).forEach(arg_0 -> ((JsonArray)jsonArray).add(arg_0));
