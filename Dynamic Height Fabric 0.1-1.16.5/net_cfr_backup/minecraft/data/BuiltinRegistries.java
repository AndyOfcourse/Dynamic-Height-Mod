...
public class BuiltinRegistries {
    ...
    private static final WritableRegistry<WritableRegistry<?>> WRITABLE_REGISTRY = new MappedRegistry(ResourceKey.createRegistryKey((ResourceLocation)new ResourceLocation("root")), Lifecycle.experimental());
    ...
    public static <V, T extends V> T register(Registry<V> registry, ResourceLocation resourceLocation, T object) {
        return (T)((WritableRegistry)registry).register(ResourceKey.create((ResourceKey)registry.key(), (ResourceLocation)resourceLocation), object, Lifecycle.stable());
    }

    public static <V, T extends V> T registerMapping(Registry<V> registry, int i, ResourceKey<V> resourceKey, T object) {
        return (T)((WritableRegistry)registry).registerMapping(i, resourceKey, object, Lifecycle.stable());
    }
