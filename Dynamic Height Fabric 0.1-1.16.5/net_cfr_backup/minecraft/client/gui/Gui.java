...
extends GuiComponent {
    ...
    public Gui(Minecraft minecraft) {
        ...
        this.chatListeners.get(ChatType.CHAT).add((ChatListener)new StandardChatListener(minecraft));
        this.chatListeners.get(ChatType.CHAT).add((ChatListener)chatListener);
        this.chatListeners.get(ChatType.SYSTEM).add((ChatListener)new StandardChatListener(minecraft));
        this.chatListeners.get(ChatType.SYSTEM).add((ChatListener)chatListener);
        this.chatListeners.get(ChatType.GAME_INFO).add((ChatListener)new OverlayChatListener(minecraft));
    ...
    public void render(PoseStack poseStack, float f) {
        ...
        if ((g = Mth.lerp((float)f, (float)this.minecraft.player.oPortalTime, (float)this.minecraft.player.portalTime)) > 0.0f && !this.minecraft.player.hasEffect(MobEffects.CONFUSION)) {
        ...
        if (this.minecraft.player.getSleepTimer() > 0) {
            ...
            Gui.fill((PoseStack)poseStack, (int)0, (int)0, (int)this.screenWidth, (int)this.screenHeight, (int)k);
            RenderSystem.enableAlphaTest();
            RenderSystem.enableDepthTest();
            this.minecraft.getProfiler().pop();
            RenderSystem.color4f((float)1.0f, (float)1.0f, (float)1.0f, (float)1.0f);
        ...
        if (!this.minecraft.options.hideGui) {
            ...
            if (this.overlayMessageString != null && this.overlayMessageTime > 0) {
                ...
                if (l > 8) {
                    ...
                    RenderSystem.translatef((float)(this.screenWidth / 2), (float)(this.screenHeight - 68), (float)0.0f);
                    RenderSystem.enableBlend();
                    RenderSystem.defaultBlendFunc();
                    k = 0xFFFFFF;
                    if (this.animateOverlayMessageColor) {
                        k = Mth.hsvToRgb((float)(h / 50.0f), (float)0.7f, (float)0.6f) & 0xFFFFFF;
                    }
                    m = l << 24 & 0xFF000000;
                    n = font.width((FormattedText)this.overlayMessageString);
            ...
            if (this.title != null && this.titleTime > 0) {
                ...
                if ((l = Mth.clamp((int)l, (int)0, (int)255)) > 8) {
                    RenderSystem.pushMatrix();
                    RenderSystem.translatef((float)(this.screenWidth / 2), (float)(this.screenHeight / 2), (float)0.0f);
                    RenderSystem.enableBlend();
                    RenderSystem.defaultBlendFunc();
                    RenderSystem.pushMatrix();
                    RenderSystem.scalef((float)4.0f, (float)4.0f, (float)4.0f);
                    int k2 = l << 24 & 0xFF000000;
                    m = font.width((FormattedText)this.title);
                    ...
                    if (this.subtitle != null) {
                        ...
                        n = font.width((FormattedText)this.subtitle);
            ...
            RenderSystem.disableAlphaTest();
            RenderSystem.pushMatrix();
            RenderSystem.translatef((float)0.0f, (float)(this.screenHeight - 48), (float)0.0f);
    ...
    private void drawBackdrop(PoseStack poseStack, Font font, int i, int j, int k) {
        ...
        if (l != 0) {
            int m = -j / 2;
            font.getClass();
            Gui.fill((PoseStack)poseStack, (int)(m - 2), (int)(i - 2), (int)(m + j + 2), (int)(i + 9 + 2), (int)FastColor.ARGB32.multiply((int)l, (int)k));
        }
    }
    ...
    private void renderCrosshair(PoseStack poseStack) {
        ...
        if (options.renderDebug && !options.hideGui && !this.minecraft.player.isReducedDebugInfo() && !options.reducedDebugInfo) {
            ...
            RenderSystem.rotatef((float)camera.getXRot(), (float)-1.0f, (float)0.0f, (float)0.0f);
            RenderSystem.rotatef((float)camera.getYRot(), (float)0.0f, (float)1.0f, (float)0.0f);
        ...
        for (MobEffectInstance mobEffectInstance : Ordering.natural().reverse().sortedCopy((Iterable)collection)) {
            ...
            if (mobEffectInstance.isAmbient()) {
                ...
                if (mobEffectInstance.getDuration() <= 200) {
                    ...
                    f = Mth.clamp((float)((float)mobEffectInstance.getDuration() / 10.0f / 5.0f * 0.5f), (float)0.0f, (float)0.5f) + Mth.cos((float)((float)mobEffectInstance.getDuration() * (float)Math.PI / 5.0f)) * Mth.clamp((float)((float)m / 10.0f * 0.25f), (float)0.0f, (float)0.25f);
                }
            }
            ...
            list.add(() -> {
                ...
                RenderSystem.color4f((float)1.0f, (float)1.0f, (float)1.0f, (float)g);
                Gui.blit((PoseStack)poseStack, (int)(n + 3), (int)(o + 3), (int)this.getBlitOffset(), (int)18, (int)18, (TextureAtlasSprite)textureAtlasSprite);
            });
        }
    ...
    protected void renderHotbar(float f, PoseStack poseStack) {
        ...
        for (m = 0; m < 9; ++m) {
            ...
            this.renderSlot(n, o, f, player, (ItemStack)player.inventory.items.get(m));
        }
        if (!itemStack.isEmpty()) {
    ...
    public void renderSelectedItemName(PoseStack poseStack) {
        ...
        if (this.toolHighlightTimer > 0 && !this.lastToolHighlight.isEmpty()) {
            ...
            if (l > 0) {
                ...
                Gui.fill((PoseStack)poseStack, (int)(j - 2), (int)(k - 2), (int)(j + i + 2), (int)(k + 9 + 2), (int)this.minecraft.options.getBackgroundColor(0));
                this.getFont().drawShadow(poseStack, (Component)mutableComponent, (float)j, (float)k, 0xFFFFFF + (l << 24));
                RenderSystem.disableBlend();
                RenderSystem.popMatrix();
            }
        }
    ...
    public void renderDemoOverlay(PoseStack poseStack) {
        ...
        Object component = this.minecraft.level.getGameTime() >= 120500L ? DEMO_EXPIRED_TEXT : new TranslatableComponent("demo.remainingTime", new Object[]{StringUtil.formatTickDuration((int)((int)(120500L - this.minecraft.level.getGameTime())))});
    ...
    private void displayScoreboardSidebar(PoseStack poseStack, Objective objective) {
        ...
        ArrayList collection = scoreboard.getPlayerScores(objective);
        ArrayList list = collection.stream().filter(score -> score.getOwner() != null && !score.getOwner().startsWith("#")).collect(Collectors.toList());
        ...
        int j = i = this.getFont().width((FormattedText)component);
        int k = this.getFont().width(": ");
        for (Score score2 : collection) {
            PlayerTeam playerTeam = scoreboard.getPlayersTeam(score2.getOwner());
            MutableComponent component2 = PlayerTeam.formatNameForTeam((Team)playerTeam, (Component)new TextComponent(score2.getOwner()));
            list2.add(Pair.of((Object)score2, (Object)component2));
            j = Math.max(j, this.getFont().width((FormattedText)component2) + k + this.getFont().width(Integer.toString(score2.getScore())));
        }
        ...
        for (Pair pair : list2) {
            ...
            this.getFont().getClass();
            Gui.fill((PoseStack)poseStack, (int)(s - 2), (int)t, (int)u, (int)(t + 9), (int)q);
            ...
            this.getFont().getClass();
            Gui.fill((PoseStack)poseStack, (int)(s - 2), (int)(t - 9 - 1), (int)u, (int)(t - 1), (int)r);
            Gui.fill((PoseStack)poseStack, (int)(s - 2), (int)(t - 1), (int)u, (int)t, (int)q);
            Font font = this.getFont();
            float f = s + j / 2 - i / 2;
            this.getFont().getClass();
            font.draw(poseStack, component, f, (float)(t - 9), -1);
        }
    }
    ...
    private void renderPlayerHealth(PoseStack poseStack) {
        ...
        int p = Mth.ceil((float)player.getAbsorptionAmount());
        ...
        if (player.hasEffect(MobEffects.REGENERATION)) {
            w = this.tickCount % Mth.ceil((float)(f + 5.0f));
        }
        ...
        for (x = Mth.ceil((float)((f + (float)p) / 2.0f)) - 1; x >= 0; --x) {
            y = 16;
            ...
            aa = Mth.ceil((float)((float)(x + 1) / 10.0f)) - 1;
            ab = m + x % 10 * 8;
            ac = o - aa * r;
            if (i <= 4) {
        ...
        if (player.isEyeInFluid((Tag)FluidTags.WATER) || aa < z) {
            ab = this.getVisibleVehicleHeartRows(y) - 1;
            t -= ab * 10;
            ac = Mth.ceil((double)((double)(aa - 2) * 10.0 / (double)z));
            ad = Mth.ceil((double)((double)aa * 10.0 / (double)z)) - ac;
    ...
    private void updateVignetteBrightness(Entity entity) {
        ...
        float f = Mth.clamp((float)(1.0f - entity.getBrightness()), (float)0.0f, (float)1.0f);
    ...
    private void renderVignette(Entity entity) {
        ...
        if (f > 0.0f) {
            ...
            RenderSystem.color4f((float)this.vignetteBrightness, (float)this.vignetteBrightness, (float)this.vignetteBrightness, (float)1.0f);
        }
    ...
    private void renderSlot(int i, int j, float f, Player player, ItemStack itemStack) {
        ...
        if (g > 0.0f) {
            RenderSystem.pushMatrix();
            float h = 1.0f + g / 5.0f;
            RenderSystem.translatef((float)(i + 8), (float)(j + 12), (float)0.0f);
            RenderSystem.scalef((float)(1.0f / h), (float)((h + 1.0f) / 2.0f), (float)1.0f);
            RenderSystem.translatef((float)(-(i + 8)), (float)(-(j + 12)), (float)0.0f);
        }
        this.itemRenderer.renderAndDecorateItem((LivingEntity)player, itemStack, i, j);
        if (g > 0.0f) {
            RenderSystem.popMatrix();
        }
    ...
    public void setNowPlaying(Component component) {
        this.setOverlayMessage((Component)new TranslatableComponent("record.nowPlaying", new Object[]{component}), true);
    }
