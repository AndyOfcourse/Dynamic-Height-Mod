...
public class ClientChunkCache extends ChunkSource {
	...
	public LevelChunk replaceWithPacketData(
		int i, int j, @Nullable ChunkBiomeContainer chunkBiomeContainer, FriendlyByteBuf friendlyByteBuf, CompoundTag compoundTag, long[] mask, boolean bl
	) {
		if (!this.storage.inRange(i, j)) {
			...
			if (!bl && isValidChunk(levelChunk, i, j)) {
				levelChunk.replaceWithPacketData(chunkBiomeContainer, friendlyByteBuf, compoundTag, mask);
			} else {
