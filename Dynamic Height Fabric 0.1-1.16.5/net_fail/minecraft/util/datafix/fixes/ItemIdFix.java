...
public class ItemIdFix extends DataFix {
   private static final Int2ObjectMap<String> ITEM_NAMES = (Int2ObjectMap<String>)DataFixUtils.make(new Int2ObjectOpenHashMap(), int2ObjectOpenHashMap -> {
   ...
   public TypeRewriteRule makeRule() {
      ...
      return this.fixTypeEverywhereTyped(
         ...
         typed -> typed.update(
               opticFinder, type2, either -> (Pair)either.map(integer -> Pair.of(References.ITEM_NAME.typeName(), getItem(integer)), pair -> pair)
            )
      );
   }
}
