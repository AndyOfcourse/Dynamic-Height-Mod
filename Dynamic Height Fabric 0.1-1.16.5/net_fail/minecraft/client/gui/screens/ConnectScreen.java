               ...
               ConnectScreen.this.connection
                  .setListener(
                     new ClientHandshakePacketListenerImpl(
                        ...
                        component -> ConnectScreen.this.updateStatus(component)
                     )
                  );
               ...
               ConnectScreen.this.minecraft
                  .execute(
                     () -> ConnectScreen.this.minecraft
                           .setScreen(
                              new DisconnectedScreen(
                                 ConnectScreen.this.parent, CommonComponents.CONNECT_FAILED, new TranslatableComponent("disconnect.genericReason", string)
                              )
                           )
                  );
            }
