...
public class MultiNoiseBiomeSource extends BiomeSource {
   ...
   public static final MapCodec<MultiNoiseBiomeSource> DIRECT_CODEC = RecordCodecBuilder.mapCodec(
      instance -> instance.group(
               ...
               MultiNoiseBiomeSource.NoiseParameters.CODEC
                  ...
                  .forGetter(multiNoiseBiomeSource -> multiNoiseBiomeSource.temperatureParams),
   ...
   public static final Codec<MultiNoiseBiomeSource> CODEC = Codec.mapEither(MultiNoiseBiomeSource.PresetInstance.CODEC, DIRECT_CODEC)
      .xmap(
         either -> (MultiNoiseBiomeSource)either.map(MultiNoiseBiomeSource.PresetInstance::biomeSource, Function.identity()),
   ...
   public static class Preset {
      ...
      public static final MultiNoiseBiomeSource.Preset NETHER = new MultiNoiseBiomeSource.Preset(
         ...
         (preset, registry, long_) -> new MultiNoiseBiomeSource(
               long_,
               ImmutableList.of(
                  Pair.of(new Biome.ClimateParameters(0.0F, 0.0F, 0.0F, 0.0F, 0.0F), (Supplier<Biome>)() -> registry.getOrThrow(Biomes.NETHER_WASTES)),
                  Pair.of(new Biome.ClimateParameters(0.0F, -0.5F, 0.0F, 0.0F, 0.0F), (Supplier<Biome>)() -> registry.getOrThrow(Biomes.SOUL_SAND_VALLEY)),
                  Pair.of(new Biome.ClimateParameters(0.4F, 0.0F, 0.0F, 0.0F, 0.0F), (Supplier<Biome>)() -> registry.getOrThrow(Biomes.CRIMSON_FOREST)),
                  Pair.of(new Biome.ClimateParameters(0.0F, 0.5F, 0.0F, 0.0F, 0.375F), (Supplier<Biome>)() -> registry.getOrThrow(Biomes.WARPED_FOREST)),
                  Pair.of(new Biome.ClimateParameters(-0.5F, 0.0F, 0.0F, 0.0F, 0.175F), (Supplier<Biome>)() -> registry.getOrThrow(Biomes.BASALT_DELTAS))
               ),
      ...
      public MultiNoiseBiomeSource biomeSource(Registry<Biome> registry, long l) {
         return (MultiNoiseBiomeSource)this.biomeSource.apply(this, registry, l);
      }
   }
