...
public class BiomeGenerationSettings {
   ...
   private BiomeGenerationSettings(
      ...
      this.flowerFeatures = list.stream()
   ...
   public boolean isValidStart(StructureFeature<?> structureFeature) {
      return this.structureStarts.stream().anyMatch(supplier -> supplier.get().feature == structureFeature);
   }
   ...
   public static class Builder {
      ...
      public <C extends CarverConfiguration> BiomeGenerationSettings.Builder addCarver(
         ...
         this.carvers.computeIfAbsent(carving, carvingx -> Lists.newArrayList()).add(() -> configuredWorldCarver);
         return this;
      }
