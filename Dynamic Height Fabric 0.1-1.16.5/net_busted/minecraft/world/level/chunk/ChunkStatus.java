...
public class ChunkStatus {
   ...
   public static final ChunkStatus FULL = register(
      ...
      (chunkStatus, serverLevel, chunkGenerator, structureManager, threadedLevelLightEngine, function, list, chunkAccess) -> function.apply(chunkAccess),
      (chunkStatus, serverLevel, structureManager, threadedLevelLightEngine, function, chunkAccess) -> function.apply(chunkAccess)
   );
   ...
   public CompletableFuture<Either<ChunkAccess, ChunkHolder.ChunkLoadingFailure>> generate(
      ...
      return this.generationTask
         .doWork(this, serverLevel, chunkGenerator, structureManager, threadedLevelLightEngine, function, list, list.get(list.size() / 2));
   }
