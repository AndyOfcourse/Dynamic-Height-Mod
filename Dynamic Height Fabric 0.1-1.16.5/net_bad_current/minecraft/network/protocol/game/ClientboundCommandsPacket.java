...
public class ClientboundCommandsPacket implements Packet<ClientGamePacketListener> {
   ...
   private static void resolveEntries(ClientboundCommandsPacket.Entry[] entrys) {
      List<ClientboundCommandsPacket.Entry> list = Lists.newArrayList(entrys);
   ...
   private static CommandNode<SharedSuggestionProvider>[] getNodesInIdOrder(Object2IntMap<CommandNode<SharedSuggestionProvider>> object2IntMap) {
      ...
      it.unimi.dsi.fastutil.objects.Object2IntMap.Entry<CommandNode<SharedSuggestionProvider>> entry;
      for(ObjectIterator var2 = Object2IntMaps.fastIterable(object2IntMap).iterator();
         var2.hasNext();
         commandNodes[entry.getIntValue()] = (CommandNode)entry.getKey()
      ) {
         entry = (it.unimi.dsi.fastutil.objects.Object2IntMap.Entry)var2.next();
      }
