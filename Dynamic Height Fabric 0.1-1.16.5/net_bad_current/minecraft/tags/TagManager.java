      ...
      return CompletableFuture.allOf(completableFuture, completableFuture2, completableFuture3, completableFuture4)
         ...
         .thenAcceptAsync(
            void_ -> {
               ...
               TagCollection<Item> tagCollection2 = this.items.load(completableFuture2.join());
               TagCollection<Fluid> tagCollection3 = this.fluids.load(completableFuture3.join());
               TagCollection<EntityType<?>> tagCollection4 = this.entityTypes.load(completableFuture4.join());
