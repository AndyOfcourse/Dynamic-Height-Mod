      ...
      if (!this.isNearPlayer()) {
         ...
         if (!(level instanceof ServerLevel)) {
            ...
            for(int i = 0; i < this.spawnCount; ++i) {
               ...
               if (level.noCollision(optional.get().getAABB(g, h, k))) {
                  ServerLevel serverLevel = (ServerLevel)level;
                  if (SpawnPlacements.checkSpawnRules(optional.get(), serverLevel, MobSpawnType.SPAWNER, new BlockPos(g, h, k), level.getRandom())) {
