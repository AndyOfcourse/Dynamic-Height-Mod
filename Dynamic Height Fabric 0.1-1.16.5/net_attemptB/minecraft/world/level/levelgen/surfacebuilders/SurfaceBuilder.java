...
public abstract class SurfaceBuilder<C extends SurfaceBuilderConfiguration> {
   ...
   public static final SurfaceBuilderBaseConfiguration CONFIG_CRIMSON_FOREST = new SurfaceBuilderBaseConfiguration(
      CRIMSON_NYLIUM, NETHERRACK, NETHER_WART_BLOCK
   );
