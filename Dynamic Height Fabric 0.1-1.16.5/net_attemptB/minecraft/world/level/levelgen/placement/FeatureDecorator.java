...
public abstract class FeatureDecorator<DC extends DecoratorConfiguration> {
   ...
   public static final FeatureDecorator<NoneDecoratorConfiguration> HEIGHTMAP = register(
      "heightmap", new HeightmapDecorator<>(NoneDecoratorConfiguration.CODEC)
   );
   ...
   public FeatureDecorator(Codec<DC> codec) {
      this.configuredCodec = codec.fieldOf("config")
         .xmap(decoratorConfiguration -> new ConfiguredDecorator<>(this, (DC)decoratorConfiguration), ConfiguredDecorator::config)
         .codec();
   }
