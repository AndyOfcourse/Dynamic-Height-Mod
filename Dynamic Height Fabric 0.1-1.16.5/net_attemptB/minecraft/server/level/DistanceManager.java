...
public abstract class DistanceManager {
   ...
   public void addPlayer(SectionPos sectionPos, ServerPlayer serverPlayer) {
      ...
      ((ObjectSet)this.playersPerChunk.computeIfAbsent(l, lx -> new ObjectOpenHashSet())).add(serverPlayer);
   ...
   public void removePlayer(SectionPos sectionPos, ServerPlayer serverPlayer) {
      long l = sectionPos.chunk().toLong();
      ObjectSet<ServerPlayer> objectSet = (ObjectSet)this.playersPerChunk.get(l);
   ...
   class FixedPlayerDistanceChunkTracker extends ChunkTracker {
      ...
      private boolean havePlayer(long l) {
         ObjectSet<ServerPlayer> objectSet = (ObjectSet)DistanceManager.this.playersPerChunk.get(l);
               ...
               DistanceManager.this.ticketThrottlerReleaser
                  .tell(
                     ChunkTaskPriorityQueueSorter.release(
                        () -> DistanceManager.this.mainThreadExecutor.execute(() -> DistanceManager.this.removeTicket(l, ticket)), l, true
                     )
                  );
            }
         }
