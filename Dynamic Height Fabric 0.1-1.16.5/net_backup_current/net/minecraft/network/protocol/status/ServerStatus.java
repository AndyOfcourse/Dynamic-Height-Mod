   ...
   public static class Serializer implements JsonDeserializer<ServerStatus>, JsonSerializer<ServerStatus> {
      public ServerStatus deserialize(JsonElement jsonElement, Type type, JsonDeserializationContext jsonDeserializationContext) throws JsonParseException {
         ...
         if (jsonObject.has("players")) {
            serverStatus.setPlayers((ServerStatus.Players)jsonDeserializationContext.deserialize(jsonObject.get("players"), ServerStatus.Players.class));
         }

         if (jsonObject.has("version")) {
            serverStatus.setVersion((ServerStatus.Version)jsonDeserializationContext.deserialize(jsonObject.get("version"), ServerStatus.Version.class));
         }
