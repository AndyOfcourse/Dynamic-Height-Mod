   ...
   class BiomeList extends ObjectSelectionList<CreateBuffetWorldScreen.BiomeList.Entry> {
      private BiomeList() {
         ...
         CreateBuffetWorldScreen.this.biomes
            ...
            .forEach(entry -> this.addEntry(new CreateBuffetWorldScreen.BiomeList.Entry(entry.getValue())));
      }
      ...
      public void setSelected(@Nullable CreateBuffetWorldScreen.BiomeList.Entry entry) {
         ...
         if (entry != null) {
            ...
            NarratorChatListener.INSTANCE
               .sayNow(new TranslatableComponent("narrator.select", CreateBuffetWorldScreen.this.biomes.getKey(entry.biome)).getString());
         }
