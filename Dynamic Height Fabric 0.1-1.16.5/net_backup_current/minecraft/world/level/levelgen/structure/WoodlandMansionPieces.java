...
public class WoodlandMansionPieces {
   ...
   static class MansionPiecePlacer {
            ...
            for(int o = 0; o < simpleGrid4.height; ++o) {
               for(int p = 0; p < simpleGrid4.width; ++p) {
                  ...
                  if (simpleGrid4.get(p, o) == 2 || bl2) {
                     ...
                     if (!list2.isEmpty()) {
                        direction2 = list2.get(this.random.nextInt(list2.size()));
                     ...
                     if (WoodlandMansionPieces.MansionGrid.isHouse(simpleGrid4, p - 1, o) && !mansionGrid.isRoomId(simpleGrid4, p - 1, o, l, s)) {
                        list.add(
                           new WoodlandMansionPieces.WoodlandMansionPiece(
                              this.structureManager, direction2 == Direction.WEST ? string4 : string3, blockPos4, rotation
                           )
                        );
                     }
                     ...
                     if (simpleGrid4.get(p + 1, o) == 1 && !bl2) {
                        ...
                        list.add(
                           new WoodlandMansionPieces.WoodlandMansionPiece(
                              this.structureManager, direction2 == Direction.EAST ? string4 : string3, blockPos5, rotation
                           )
                        );
                     }
         ...
         do {
            if (!WoodlandMansionPieces.MansionGrid.isHouse(simpleGrid, m + direction.getStepX(), n + direction.getStepZ())) {
               ...
               && WoodlandMansionPieces.MansionGrid.isHouse(
                  simpleGrid,
                  m + direction.getStepX() + direction.getCounterClockWise().getStepX(),
                  n + direction.getStepZ() + direction.getCounterClockWise().getStepZ()
               )) {
            ...
            for(int j = 0; j < simpleGrid.width; ++j) {
               ...
               if (WoodlandMansionPieces.MansionGrid.isHouse(simpleGrid, j, i) && !bl) {
                  ...
                  if (!WoodlandMansionPieces.MansionGrid.isHouse(simpleGrid, j - 1, i)) {
                     ...
                     list.add(
                        new WoodlandMansionPieces.WoodlandMansionPiece(
                           this.structureManager, "roof_front", blockPos3, rotation.getRotated(Rotation.CLOCKWISE_180)
                        )
                     );
                  }
                  ...
                  if (!WoodlandMansionPieces.MansionGrid.isHouse(simpleGrid, j, i - 1)) {
                     ...
                     list.add(
                        new WoodlandMansionPieces.WoodlandMansionPiece(
                           this.structureManager, "roof_front", blockPos3, rotation.getRotated(Rotation.COUNTERCLOCKWISE_90)
                        )
                     );
                  }
                  ...
                  if (!WoodlandMansionPieces.MansionGrid.isHouse(simpleGrid, j, i + 1)) {
                     ...
                     list.add(
                        new WoodlandMansionPieces.WoodlandMansionPiece(
                           this.structureManager, "roof_front", blockPos3, rotation.getRotated(Rotation.CLOCKWISE_90)
                        )
                     );
                  }
               }
               ...
               for(int j = 0; j < simpleGrid.width; ++j) {
                  ...
                  if (WoodlandMansionPieces.MansionGrid.isHouse(simpleGrid, j, i) && bl) {
                     ...
                     if (!WoodlandMansionPieces.MansionGrid.isHouse(simpleGrid, j - 1, i)) {
                        ...
                        list.add(
                           new WoodlandMansionPieces.WoodlandMansionPiece(
                              this.structureManager, "small_wall", blockPos3, rotation.getRotated(Rotation.CLOCKWISE_180)
                           )
                        );
                     }
                     ...
                     if (!WoodlandMansionPieces.MansionGrid.isHouse(simpleGrid, j, i - 1)) {
                        ...
                        list.add(
                           new WoodlandMansionPieces.WoodlandMansionPiece(
                              this.structureManager, "small_wall", blockPos3, rotation.getRotated(Rotation.COUNTERCLOCKWISE_90)
                           )
                        );
                     }
                     ...
                     if (!WoodlandMansionPieces.MansionGrid.isHouse(simpleGrid, j, i + 1)) {
                        ...
                        list.add(
                           new WoodlandMansionPieces.WoodlandMansionPiece(
                              this.structureManager, "small_wall", blockPos3, rotation.getRotated(Rotation.CLOCKWISE_90)
                           )
                        );
                     }
                     ...
                     if (!WoodlandMansionPieces.MansionGrid.isHouse(simpleGrid, j + 1, i)) {
                        ...
                        if (!WoodlandMansionPieces.MansionGrid.isHouse(simpleGrid, j, i + 1)) {
                           ...
                           list.add(
                              new WoodlandMansionPieces.WoodlandMansionPiece(
                                 this.structureManager, "small_wall_corner", blockPos3, rotation.getRotated(Rotation.CLOCKWISE_90)
                              )
                           );
                        }
                     }
                     ...
                     if (!WoodlandMansionPieces.MansionGrid.isHouse(simpleGrid, j - 1, i)) {
                        ...
                        if (!WoodlandMansionPieces.MansionGrid.isHouse(simpleGrid, j, i + 1)) {
                           ...
                           list.add(
                              new WoodlandMansionPieces.WoodlandMansionPiece(
                                 this.structureManager, "small_wall_corner", blockPos3, rotation.getRotated(Rotation.CLOCKWISE_180)
                              )
                           );
                        }
                     }
               ...
               if (WoodlandMansionPieces.MansionGrid.isHouse(simpleGrid, j, i) && !bl) {
                  if (!WoodlandMansionPieces.MansionGrid.isHouse(simpleGrid, j + 1, i)) {
                     ...
                     if (!WoodlandMansionPieces.MansionGrid.isHouse(simpleGrid, j, i - 1)) {
                        list.add(
                           new WoodlandMansionPieces.WoodlandMansionPiece(
                              this.structureManager, "roof_corner", blockPos3, rotation.getRotated(Rotation.COUNTERCLOCKWISE_90)
                           )
                        );
                     } else if (WoodlandMansionPieces.MansionGrid.isHouse(simpleGrid, j + 1, i - 1)) {
                        ...
                        list.add(
                           new WoodlandMansionPieces.WoodlandMansionPiece(
                              this.structureManager, "roof_inner_corner", blockPos4, rotation.getRotated(Rotation.CLOCKWISE_90)
                           )
                        );
                     }
                  }
                  ...
                  if (!WoodlandMansionPieces.MansionGrid.isHouse(simpleGrid, j - 1, i)) {
                     ...
                     if (!WoodlandMansionPieces.MansionGrid.isHouse(simpleGrid, j, i + 1)) {
                        ...
                        list.add(
                           new WoodlandMansionPieces.WoodlandMansionPiece(
                              this.structureManager, "roof_corner", blockPos4, rotation.getRotated(Rotation.CLOCKWISE_90)
                           )
                        );
                     } else if (WoodlandMansionPieces.MansionGrid.isHouse(simpleGrid, j - 1, i + 1)) {
                     ...
                     if (!WoodlandMansionPieces.MansionGrid.isHouse(simpleGrid, j, i - 1)) {
                        list.add(
                           new WoodlandMansionPieces.WoodlandMansionPiece(
                              this.structureManager, "roof_corner", blockPos3, rotation.getRotated(Rotation.CLOCKWISE_180)
                           )
                        );
                     } else if (WoodlandMansionPieces.MansionGrid.isHouse(simpleGrid, j - 1, i - 1)) {
                        ...
                        list.add(
                           new WoodlandMansionPieces.WoodlandMansionPiece(
                              this.structureManager, "roof_inner_corner", blockPos4, rotation.getRotated(Rotation.CLOCKWISE_180)
                           )
                        );
                     }
                  }
      ...
      private void entrance(List<WoodlandMansionPieces.WoodlandMansionPiece> list, WoodlandMansionPieces.PlacementData placementData) {
         ...
         list.add(
            new WoodlandMansionPieces.WoodlandMansionPiece(
               this.structureManager, "entrance", placementData.position.relative(direction, 9), placementData.rotation
            )
         );
      ...
      private void addRoom1x2(
         ...
         if (direction2 == Direction.EAST && direction == Direction.SOUTH) {
            ...
            list.add(
               new WoodlandMansionPieces.WoodlandMansionPiece(
                  this.structureManager, floorRoomCollection.get1x2SideEntrance(this.random, bl), blockPos2, rotation
               )
            );
            ...
            list.add(
               new WoodlandMansionPieces.WoodlandMansionPiece(
                  this.structureManager, floorRoomCollection.get1x2FrontEntrance(this.random, bl), blockPos2, rotation
               )
            );
      ...
      private void addRoom2x2Secret(
         ...
         list.add(
            new WoodlandMansionPieces.WoodlandMansionPiece(
               this.structureManager, floorRoomCollection.get2x2Secret(this.random), blockPos2, rotation, Mirror.NONE
            )
         );
      }
   }
