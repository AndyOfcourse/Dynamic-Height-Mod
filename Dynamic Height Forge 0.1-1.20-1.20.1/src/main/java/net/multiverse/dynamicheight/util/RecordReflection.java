 ...
 * Forge's class loading can sometimes strip the accessor methods from record components; this helper
 * tolerates that by falling back to reflective field access when necessary.
 */
